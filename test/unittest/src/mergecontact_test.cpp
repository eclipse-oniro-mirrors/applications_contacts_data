...
void MergeContactTest::DeleteRawContact()
{
    ...
    OHOS::Uri uriRawContact(ContactsUri::CONTACT);
...
void MergeContactTest::CheckMergeResultId(std::vector<int64_t> ids, bool merge)
{
    ...
    for (int i = 1; i < size; i++) {
        if (merge) {
            ...
            HILOG_INFO("merge contact_id = %{public}ld, contact_idTwo %{public}ld", (long) contactId, (long) resultIdVector[i]);
        } else {
            EXPECT_NE(contactId, resultIdVector[i]);
            HILOG_INFO("split contact_id = %{public}ld", (long) resultIdVector[i]);
        }
    }
}
...
HWTEST_F(MergeContactTest, merge_Query_test_100, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Query_test_100 dataIdOne  = %{public}ld", (long) dataIdOne);
    ...
    HILOG_INFO("merge_Query_test_100 dataIdTwo  = %{public}ld", (long) dataIdTwo);
...
HWTEST_F(MergeContactTest, merge_Update_test_200, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Update_test_200 :  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaochenc");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaochenc", "");
    HILOG_INFO("merge_Update_test_200 :  = %{public}ld", (long) dataIdTwo);
    int time = 2000;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
...
HWTEST_F(MergeContactTest, merge_Update_test_300, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_300 :  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaomingmm");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaomingmm", "");
    HILOG_INFO("merge_Update_test_300 :  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_400, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_400 :  = %{public}ld", (long) dataIdOne);
    ...
    HILOG_INFO("merge_Update_test_400 :  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_500, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_500 :  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaozhang");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaozhang", "");
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "1234567", "");
    HILOG_INFO("merge_Update_test_500 :  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_600, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_600 dataIdOne_1  = %{public}ld", (long) dataIdOne);
    dataIdOne = ContactDataInsert(rawOne, "phone", "1234567", "");
    HILOG_INFO("merge_Update_test_600 dataIdOne_2  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaozhou");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaozhou", "");
    HILOG_INFO("merge_Update_test_600 :  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_700, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_700 dataIdOne_1  = %{public}ld", (long) dataIdOne);
    dataIdOne = ContactDataInsert(rawOne, "phone", "1234567", "");
    HILOG_INFO("merge_Update_test_700 dataIdOne_2  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaobai");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaobai", "");
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_700 dataIdTwo_1  = %{public}ld", (long) dataIdTwo);
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "1234567", "");
    HILOG_INFO("merge_Update_test_700 dataIdTwo_2  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_800, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_800 dataIdOne_1  = %{public}ld", (long) dataIdOne);
    dataIdOne = ContactDataInsert(rawOne, "phone", "1234567", "");
    HILOG_INFO("merge_Update_test_800 dataIdOne_2  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaomi");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaomi", "");
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_800 dataIdTwo_1  = %{public}ld", (long) dataIdTwo);
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "12345678", "");
    HILOG_INFO("merge_Update_test_800 dataIdTwo_2  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_900, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_900 dataIdOne_1  = %{public}ld", (long) dataIdOne);
    dataIdOne = ContactDataInsert(rawOne, "phone", "1234567", "");
    HILOG_INFO("merge_Update_test_900 dataIdOne_2  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("daniu");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "daniu", "");
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_900 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_1000, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_1000 dataIdOne_1  = %{public}ld", (long) dataIdOne);
    dataIdOne = ContactDataInsert(rawOne, "phone", "1234567", "");
    HILOG_INFO("merge_Update_test_1000 dataIdOne_2  = %{public}ld", (long) dataIdOne);
    ...
    HILOG_INFO("merge_Update_test_1000 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, abnormal_merge_Update_test_1100, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("abnormal_merge_Update_test_1100 :  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaocai");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaocai", "");
    HILOG_INFO("abnormal_merge_Update_test_1100 :  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_1200, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Update_test_1200 :  = %{public}ld", (long) dataIdOne);
    ...
    HILOG_INFO("merge_Update_test_1200 :  = %{public}ld", (long) dataIdTwo);
    ...
    HILOG_INFO("merge_Update_test_1200 :  = %{public}ld", (long) dataIdThree);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, merge_Update_test_1300, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_1300 dataIdOne  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaohua");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaohua", "");
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "123456", "");
    HILOG_INFO("merge_Update_test_1300 dataIdTwo  = %{public}ld", (long) dataIdTwo);
...
HWTEST_F(MergeContactTest, merge_Update_test_1400, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Update_test_1400 dataIdOne  = %{public}ld", (long) dataIdOne);
    ...
    HILOG_INFO("merge_Update_test_1400 dataIdTwo  = %{public}ld", (long) dataIdTwo);
...
HWTEST_F(MergeContactTest, merge_Update_test_1500, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Update_test_1500 :  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaoli");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaolil", "");
    HILOG_INFO("merge_Update_test_1500 :  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    int ret;
...
HWTEST_F(MergeContactTest, abnormal_merge_Query_test_1600, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("abnormal_merge_Query_test_1600 dataIdOne  = %{public}ld", (long) dataIdOne);
    ...
    HILOG_INFO("abnormal_merge_Query_test_1600 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
...
HWTEST_F(MergeContactTest, abnormal_merge_Update_test_1700, testing::ext::TestSize.Level1)
{
    ...
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "123456", "");
    HILOG_INFO("abnormal_merge_Update_test_1700 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
...
HWTEST_F(MergeContactTest, abnormal_merge_Update_test_1800, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("abnormal_merge_Update_test_1800 dataIdOne  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaomei");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaomei", "");
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "123456", "");
    HILOG_INFO("abnormal_merge_Update_test_1800 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, abnormal_merge_Update_test_1900, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("abnormal_merge_Update_test_1900 dataIdOne  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("lileibob2300");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "lileibob2300", "");
    HILOG_INFO("abnormal_merge_Update_test_1900 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
...
HWTEST_F(MergeContactTest, abnormal_merge_Update_test_2000, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("abnormal_merge_Update_test_2000 dataIdOne  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaowang");
    EXPECT_GT(rawOne, 0);
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaowang", "");
    HILOG_INFO("abnormal_merge_Update_test_2000 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriAutoMerge(ContactsUri::AUTO_MERGE);
...
HWTEST_F(MergeContactTest, abnormal_merge_Update_test_2100, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("abnormal_merge_Update_test_2100 :  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaocheng");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaocheng", "");
    HILOG_INFO("abnormal_merge_Update_test_2100 :  = %{public}ld", (long) dataIdTwo);
...
HWTEST_F(MergeContactTest, merge_Update_test_2200, testing::ext::TestSize.Level1)
{
    ...
    int64_t dataIdOne = ContactDataInsert(rawOne, "name", "xiaocai", "");
    dataIdOne = ContactDataInsert(rawOne, "phone", "1234567", "");
    HILOG_INFO("merge_Update_test_2200 :  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaocai");
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "phone", "123456", "");
    dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaocai", "");
    HILOG_INFO("merge_Update_test_2200 :  = %{public}ld", (long) dataIdTwo);
    ...
    HILOG_INFO("merge_Update_test_2200 :  = %{public}ld", (long) dataIdThree);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriManualMerge(ContactsUri::MANUAL_MERGE);
...
HWTEST_F(MergeContactTest, merge_Query_test_2300, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Query_test_2300 dataIdOne  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xsiaowuwwwww");
    EXPECT_GT(rawTwo, 0);
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xsiaowuwwwww", "");
    HILOG_INFO("merge_Query_test_2300 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    std::vector<std::string> columns;
...
HWTEST_F(MergeContactTest, merge_Query_test_2400, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Query_test_2400 dataIdOne  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xsiaowuwwwww");
    EXPECT_GT(rawTwo, 0);
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xsiaowuwwwww", "");
    HILOG_INFO("merge_Query_test_2400 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriQueryMergeList(ContactsUri::MERGE_LIST);
...
HWTEST_F(MergeContactTest, merge_Query_test_2500, testing::ext::TestSize.Level1)
{
    ...
    dataIdOne = ContactDataInsert(rawOne, "phone", "123456", "");
    HILOG_INFO("merge_Query_test_2500 dataIdOne  = %{public}ld", (long) dataIdOne);
    int64_t rawTwo = RawContactInsert("xiaowuww");
    EXPECT_GT(rawTwo, 0);
    int64_t dataIdTwo = ContactDataInsert(rawTwo, "name", "xiaowuwwl", "");
    dataIdTwo = ContactDataInsert(rawTwo, "phone", "123456", "");
    HILOG_INFO("merge_Query_test_2500 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    std::vector<std::string> columns;
...
HWTEST_F(MergeContactTest, merge_Query_test_2600, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Query_test_2600 dataIdOne  = %{public}ld", (long) dataIdOne);
    ...
    HILOG_INFO("merge_Query_test_2600 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriQueryMergeList(ContactsUri::MERGE_LIST);
...
HWTEST_F(MergeContactTest, merge_Update_test_2700, testing::ext::TestSize.Level1)
{
    ...
    HILOG_INFO("merge_Update_test_2700 dataIdOne  = %{public}ld", (long) dataIdOne);
    ...
    HILOG_INFO("merge_Update_test_2700 dataIdTwo  = %{public}ld", (long) dataIdTwo);
    int time = Time::SLEEP_TIME_MERGE;
    std::chrono::milliseconds dura(time);
    std::this_thread::sleep_for(dura);
    OHOS::Uri uriManualMerge(ContactsUri::MANUAL_MERGE);
