    ...
    getProfileRawContactMap:
        function() {
            var rawContactMap = new Map([
                ...
                [ "lastest_contacted_time", "2" ], [ "favorite", "1" ], [ "favorite_order", "1" ],
    ...
    getProfileRawContactUpdateMap:
        function() {
            var rawContactMap = new Map([
                ...
                [ "lastest_contacted_time", "21" ], [ "favorite", "11" ], [ "favorite_order", "1" ],
    ...
    getProfileUpdateRawContactMap:
        function() {
            var rawContactMap = new Map([
                ...
                [ "lastest_contacted_time", "8" ], [ "favorite", "0" ], [ "favorite_order", "1" ],
