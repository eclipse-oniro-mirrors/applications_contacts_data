...
#ifndef CONTACT_SPAM_CALL_PROXY_H
#define CONTACT_SPAM_CALL_PROXY_H
...
public:
    ...
    int32_t UpdateBlockedMsgCount(const std::vector<std::string> &phoneNumbers,
        int blockType, std::shared_ptr<SpamCallAdapter> spamCallAdapter) override;
...
#endif //CONTACT_SPAM_CALL_PROXY_H
