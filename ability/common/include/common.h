...
constexpr int KIT_CONTACTS_SYNC_INFO = 40020;
constexpr int DELETE_ALL_CONTACTS = 40021;
...
// DATABASE VERSION 43
constexpr int DATABASE_VERSION_43 = 43;

// DATABASE OPEN VERSION CONTACTS
constexpr int DATABASE_CONTACTS_OPEN_VERSION = 43;
